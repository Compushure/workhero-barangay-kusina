...
export function SearchFilter({
  ...
  return (
    <div className="rounded-3xl bg-background p-4 sm:p-5 lg:p-6 xl:p-7 2xl:p-8 border-b-3 border-x-2 border-[#f47812]/15 shadow-sm/25">
      {/* Header with collapse toggle - only on small screens */}
      <button
        onClick={() => setIsCollapsed(!isCollapsed)}
        className="flex items-center justify-between w-full mb-3 sm:mb-4 lg:mb-5 sm:pointer-events-none"
        type="button"
      >
