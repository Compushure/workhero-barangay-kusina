  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-card w-[95vw] max-w-2xl mx-auto max-h-[90vh] p-0 rounded-xl shadow-xl flex flex-col border-2 border-[#f47812]/20">
        <DialogHeader className="px-3 sm:px-6 pt-3 sm:pt-6 pb-3 sm:pb-4 border-b border-[#f47812]/15 shrink-0">
          <div className="flex items-start justify-between gap-2 sm:gap-4">
            <div className="flex-1 min-w-0">
              <DialogTitle className="text-base sm:text-xl font-bold text-foreground">Edit User</DialogTitle>
            ...
            <div className="flex gap-1.5 sm:gap-2 shrink-0">
              <Button
                ...
                className="whitespace-nowrap bg-white hover:bg-gray-100 hover:text-foreground border-zinc-300 text-xs sm:text-sm h-7 sm:h-8 px-2 sm:px-3"
              >
                Edit All
              </Button>
              <Button
        ...
        <ScrollArea className="flex-1 overflow-y-auto [&::-webkit-scrollbar]:hidden md:[&::-webkit-scrollbar]:block">
          <div className="px-3 sm:px-6 py-3 sm:py-4">
            ...
            <div className="space-y-2 sm:space-y-3 p-3 sm:p-4 bg-background rounded-lg border border-[#f47812]/15">
              <p className="text-xs font-semibold text-foreground uppercase hidden sm:block">Read-Only Information</p>
