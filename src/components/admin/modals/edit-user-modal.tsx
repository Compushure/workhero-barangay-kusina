      ...
      <ScrollArea className="max-h-[calc(90vh-120px)] px-6">
        <div className="space-y-6 pb-6">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="edit-name" className="text-foreground">New Name</Label>
                ...
                {/* New Contact Number */}
                <div className="space-y-2">
                  <Label htmlFor="edit-contact" className="text-foreground">New Contact Number</Label>
                  <div className="relative">
            ...
            {/* Employment Details */}
            <div className="space-y-4">
              <h3 className="text-sm font-semibold text-primary">Employment Details (Optional)</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {/* New Role */}
                <div className="space-y-2">
                  <Label htmlFor="edit-type" className="text-foreground">New Role</Label>
                  <Select
                    ...
                    disabled={isPending}
                  >
                    <SelectTrigger id="edit-type" className="border-border focus:border-primary focus:ring-primary">
                      <div className="flex items-center gap-2">
                ...
                <div className="space-y-2">
                  <Label htmlFor="edit-status" className="text-foreground">New Employment Status</Label>
                  <Select
                    ...
                    disabled={isPending}
                  >
                    <SelectTrigger id="edit-status" className="border-border focus:border-primary focus:ring-primary">
                      <div className="flex items-center gap-2">
            ...
            {/* Address */}
            <div className="space-y-2">
              <Label htmlFor="edit-address" className="text-foreground">New Address</Label>
              <div className="relative">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {/* TIN */}
                <div className="space-y-2">
                  <Label htmlFor="edit-tin" className="text-foreground">New TIN</Label>
                  <div className="relative">
                ...
                {/* SSS */}
                <div className="space-y-2">
                  <Label htmlFor="edit-sss" className="text-foreground">New SSS</Label>
                  <div className="relative">
                    <CreditCard className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-primary" />
                    <Input
                      id="edit-sss"
                ...
                {/* Pag-IBIG */}
                <div className="space-y-2">
                  <Label htmlFor="edit-pagibig" className="text-foreground">New Pag-IBIG</Label>
                  <div className="relative">
                    <CreditCard className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-primary" />
                    <Input
                      id="edit-pagibig"
