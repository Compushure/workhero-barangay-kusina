...
function CurrentAssignedTasksSkeleton() {
  return (
    <div className="rounded-2xl bg-background-soft px-4 md:px-5 2xl:px-6 pt-3 sm:pt-5 shadow-sm/50 flex flex-col w-full">
      ...
      <section
        className="manager-sticky-controls rounded-xl px-2.5 py-2.5 sm:px-3 sm:py-3 flex min-w-0 flex-col gap-2 sm:gap-2.5 xl:flex-row xl:items-center xl:justify-between"
        style={{ zIndex: 200 }}
      >
...
export function CurrentAssignedTasks() {
  ...
  return (
    <div className="rounded-2xl bg-gray-100 px-4 md:px-5 2xl:px-6 pt-3 sm:pt-5 shadow-sm/50 flex flex-col w-full">
      ...
      <section
        className="manager-sticky-controls mt-1 rounded-xl px-2.5 py-2.5 sm:px-3 sm:py-3 flex min-w-0 flex-col gap-2 sm:gap-2.5 xl:flex-row xl:items-center xl:justify-between"
        style={{ zIndex: 200 }}
      >
        {/* Counts */}
