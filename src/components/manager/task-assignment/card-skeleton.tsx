...
export function SkeletonCard() {
  return (
    <Card className="w-full bg-card p-2 sm:p-3 md:p-4 shadow-sm/25 mb-3 sm:mb-4">
        ...
        <div className="flex flex-col lg:flex-row lg:justify-between gap-2 sm:gap-3 flex-1">
          <div className="space-y-2 w-full lg:w-2/3">
            ...
            <div className="flex flex-col sm:flex-row gap-1 sm:items-end">
              <Skeleton className="h-5 sm:h-6 w-full sm:w-2/3 bg-background" />
              <Skeleton className="h-3 sm:h-4 w-full sm:w-1/2 bg-background" />
            </div>

            {/* Date badge */}
            <Skeleton className="h-5 sm:h-6 w-40 sm:w-48 bg-background rounded-full" />
          </div>

          {/* Points/XP section */}
          <div className="flex gap-2 sm:gap-3">
            <Skeleton className="h-8 sm:h-10 w-20 sm:w-24 bg-background" />
            <Skeleton className="h-8 sm:h-10 w-16 sm:w-20 bg-background" />
          </div>
        </div>
