        ...
        <TableRow key={i} className="bg-background-soft">
          <TableCell>
            <div className="space-y-2 pl-3 sm:pl-5">
              ...
              <Skeleton className="h-4 bg-muted w-1/3" />
            </div>
          </TableCell>

          <TableCell className="text-center">
            <Skeleton className="h-6 bg-muted mx-auto w-12" />
          </TableCell>
          ...
          <TableCell className="text-center">
            <Skeleton className="h-6 bg-muted mx-auto w-15" />
          </TableCell>

          <TableCell>
            <div className="flex justify-center gap-1">
              <Skeleton className="size-7 sm:size-9 bg-muted" />
              <Skeleton className="size-7 sm:size-9 bg-muted" />
            </div>
          </TableCell>
        </TableRow>
