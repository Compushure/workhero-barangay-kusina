...
export default function XPProgress() {
  ...
  const maxXp = 500; // matches screenshot
  ...
  return (
    <div className="w-60 max-w-5xl bg-[#765332] rounded-lg shadow-md border-3 border-[#47331F] p-2 py-0 flex flex-col items-center">
      ...
      {/* Progress bar - stretched horizontally */}
      ...
      {/* Points with star icon under progress bar */}
      <div className="w-full flex items-center gap-2 text-xl text-yellow-500">
