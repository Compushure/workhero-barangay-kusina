  ...
  return (
    ...
    >
      ...
      <CollapsibleContent className="min-h-0 flex-1 overflow-hidden data-[state=closed]:hidden">
        <div className="flex h-full min-h-0 w-full flex-col overflow-hidden rounded-lg border-2 border-[#9b7a56] bg-[#f7efdf] shadow-[0_0_0_1px_rgba(155,122,86,0.2),inset_0_1px_0_rgba(255,255,255,0.35)]">
