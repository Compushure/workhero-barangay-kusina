  ...
  return (
    <>
      <Card
        ...
        className="w-full min-w-0 cursor-pointer overflow-hidden rounded-lg border-2 border-[#d4c5a8] bg-[#fdf5e8] px-3.5 py-3 text-[#3f2a1a] transition-all duration-200 hover:-translate-y-0.5 hover:border-[#c79a54] hover:shadow-[0_6px_14px_rgba(71,51,31,0.12)] active:brightness-95"
      >
        <CardContent className="flex flex-col gap-2.5 p-0 font-jersey tracking-[0.04em]">
          <div className="flex items-start justify-between gap-2.5">
            <div className="min-w-0 flex-1">
              ...
              <p
                className={`line-clamp-2 text-[18px] leading-[1.02] ${
              ...
              <span className={`mt-1.5 flex items-center gap-1.5 text-[14px] leading-none ${isOverdue ? 'text-[#8b2e22]' : 'text-[#6b5038]'}`}>
                <Calendar strokeWidth={2.5} className="size-5" />
                Due {formatDate(task.dueDate)}
              </span>
            </div>

            <div className="rounded-xl border-2 border-[#d4c5a8] bg-[#f3e4c9] px-2 py-1.5 text-center text-[12px] leading-none text-[#6b5038]">
              <div>ORDERS</div>
          ...
          <div className="flex flex-wrap items-center gap-1.5">
            ...
            <span className="rounded-md border-2 border-[#87a9bc]/35 bg-[#e0eef5] px-2 py-0.5 text-[14px] leading-none text-[#204b61]">
              XP {task.xp}
            </span>
            <span className="rounded-md border-2 border-[#d4c5a8] bg-[#fff8ec] px-2 py-0.5 text-[14px] leading-none text-[#6b5038]">
