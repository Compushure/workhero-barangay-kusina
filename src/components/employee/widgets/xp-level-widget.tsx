...
export default function XPProgress() {
  ...
  return (
    <>
      <div className="flex h-14 items-center gap-1.5 rounded-lg wood-panel px-1.5 py-1 sm:h-15 sm:gap-2 sm:px-2 sm:py-1.5 md:h-16 w-[clamp(12rem,25vw,18rem)] md:w-[clamp(15rem,30vw,21rem)] md:px-2.5">
        <div
