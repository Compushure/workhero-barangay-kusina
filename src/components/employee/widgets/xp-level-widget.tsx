...
export default function XPProgress() {
  ...
  return (
    <>
      <div className="flex h-12 items-center gap-1.5 rounded-lg wood-panel px-1.5 py-1 sm:h-15 sm:gap-2 sm:px-2 sm:py-1.5 md:h-16 w-[clamp(12rem,25vw,18rem)] md:w-[clamp(15rem,30vw,21rem)] md:px-2.5">
        <div
          onClick={() => setModalOpen(true)}
          className="flex size-10 shrink-0 cursor-pointer items-center justify-center overflow-hidden rounded-full wood-panel shadow-[2px_2px_2px_#000] shadow-[#47331F]/50 transition-transform hover:scale-105 hover:border-amber-800 sm:size-11 md:size-12"
        >
          {user ? (
            <ProfileAvatar
              userId={user.id}
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="w-full pt-0.5">
            <div className="overflow-hidden rounded-sm border-2 border-[#47331F] bg-[#273A27] h-3 md:h-5">
              <div
