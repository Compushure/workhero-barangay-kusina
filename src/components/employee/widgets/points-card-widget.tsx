...
export default function PointsCardWidget() {
  ...
  return (
    <div className="flex h-12 items-center justify-start gap-1.5 rounded-lg wood-panel px-2 shadow-md font-jersey tracking-wider sm:h-14 sm:gap-2 sm:px-2.5 w-[clamp(6rem,12vw,8rem)] md:h-16 md:w-[clamp(10rem,16vw,12rem)]">
