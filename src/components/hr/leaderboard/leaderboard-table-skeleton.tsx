          ...
          <Table className="min-w-190">
            <TableHeader>
              <TableRow className="bg-primary-gradient border-0 hover:opacity-95">
                <TableHead className="w-16 pl-3 pr-3 sm:w-20 sm:pl-5 sm:pr-4">
                ...
                <TableHead className="pr-3 text-right sm:pr-4">
                  <Skeleton className="ml-auto h-3.5 w-28 rounded bg-white/20 sm:h-4 sm:w-36" />
                </TableHead>
                <TableHead className="pr-3 text-right sm:pr-4">
